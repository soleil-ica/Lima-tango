...
#------------------------------------------------------------------
	...
	try:
        ...
        self.__video_image_cbk = VideoImageCallback(self)
            ...
            def imageStatusChanged(self, image_status):
                ...
                if self.__last_image_ready != last_image_ready:
                    ...
                    if last_image_ready >= 0:
                        data = device._image_2_struct(last_image_ready)
        ...
        self.__image_status_cbk = ImageStatusCallback(self)
    ...
    def _image_2_struct(self, frame_number):
        ...
        data = dataheader + flatimage.tostring()
...
#==================================================================
    ...
    def read_last_image(self,attr) :
        ...
        data = self._image_2_struct(last_img_ready)
...
#------------------------------------------------------------------
    ...
    def readImage(self,frame_number):
        return 'DATA_ARRAY', self._image_2_struct(frame_number)
